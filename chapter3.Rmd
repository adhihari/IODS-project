...
This shows that student who is absent for many days specially boys and girls are more prone to high alchol consumption.
...
```{r }
# Plot high_use of alchol (true or false) based on student being absent for many days in the school and if the results differ if student is boy or girl
Romplot <- ggplot(alc, aes(x = high_use, y = failures, col = sex))

# define the plot as a boxplot and draw it
Romplot + geom_boxplot() + ylab("Failures") +ggtitle("Failure student by alcohol consumption and sex")
```
